...
export const Status=({value}:{value:string})=><span className={'status '+value}>{({published:'已发布',draft:'草稿',adjusting:'调整草稿',archived:'已归档',abnormal:'异常',timeout:'超时',running:'进行中',completed:'已完成',high:'高风险',medium:'中风险',low:'低风险',departed:'已离职',active:'在职',current:'当前',pending:'待处理'} as any)[value]||value}</span>;
